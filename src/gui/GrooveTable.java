...
public class GrooveTable extends JTable {
	...
	protected GrooveTableModel model;
	protected String[] columnNames;
	private Properties settings;

	public GrooveTable(String[] columnNames, Properties settings) {
		super();
		this.settings = settings;
		this.columnNames = columnNames;
		model = new GrooveTableModel();
		initialize(model);
	}

	protected void initialize(GrooveTableModel model) {
		this.model = model;
		setModel(model);
	...
	protected class MyTableRowSorter extends TableRowSorter<TableModel> {
		...
		public MyTableRowSorter(GrooveTableModel model) {
			super(model);
